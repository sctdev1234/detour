...
const StatCard = ({ title, value, icon: Icon, color, trend }) => (
    <div className="p-6 bg-slate-800/50 backdrop-blur-md border border-slate-700/50 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 group">
