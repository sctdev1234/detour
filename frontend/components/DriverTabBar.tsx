...
export function DriverTabBar({ state, descriptors, navigation }: MaterialTopTabBarProps) {
    ...
    // Sort logic: if you want them strictly in that order. 
    // Usually state.routes order depends on definition order in _layout.tsx.
    // Let's assume _layout defines them in correct order, but we filter.
